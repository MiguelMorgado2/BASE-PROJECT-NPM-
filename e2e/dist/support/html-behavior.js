  ...
  var _ref10 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee10(page, elementIdentifier) {
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          _context10.next = 2;
          return page.locator(elementIdentifier).first().elementHandle();
        case 2:
  ...
  var _ref11 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee11(page, elementIdentifier) {
    ...
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          _context11.next = 2;
          return page.locator(elementIdentifier).elementHandles();
        case 2:
  ...
  var _ref12 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12(page, elementIdentifier, index) {
    ...
    return _regeneratorRuntime().wrap(function _callee12$(_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        case 0:
          _context12.next = 2;
          return page.locator(elementIdentifier).nth(index).elementHandle();
        case 2:
  ...
  var _ref13 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee13(page, elementIdentifier) {
    ...
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        case 0:
          _context13.next = 2;
          return page.locator(elementIdentifier).inputValue();
        case 2:
  ...
  var _ref14 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14(page, iframeIdentifier) {
    ...
    return _regeneratorRuntime().wrap(function _callee14$(_context14) {
      while (1) switch (_context14.prev = _context14.next) {
        case 0:
          _context14.next = 2;
          return page.locator(iframeIdentifier).elementHandle();
        case 2:
  ...
  var _ref15 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee15(elementIframe, elementIdentifier) {
    ...
    return _regeneratorRuntime().wrap(function _callee15$(_context15) {
      while (1) switch (_context15.prev = _context15.next) {
        case 0:
          _context15.next = 2;
          return elementIframe === null || elementIframe === void 0 ? void 0 : elementIframe.locator(elementIdentifier).elementHandle();
        case 2:
  ...
  var _ref18 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee18(page, elementIdentifier, pages, pageIndex) {
    ...
    return _regeneratorRuntime().wrap(function _callee18$(_context18) {
      while (1) switch (_context18.prev = _context18.next) {
        case 0:
          _context18.next = 2;
          return pages[pageIndex].locator(elementIdentifier).elementHandle();
        case 2:
...
var getTableData = exports.getTableData = /*#__PURE__*/function () {
  var _ref23 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee24(page, elementIdentifier) {
    var rows, table;
    return _regeneratorRuntime().wrap(function _callee24$(_context24) {
      while (1) switch (_context24.prev = _context24.next) {
        case 0:
          _context24.next = 2;
          return page.locator("".concat(elementIdentifier, " tbody tr")).all();
        case 2:
          rows = _context24.sent;
          _context24.next = 5;
          return Promise.all(rows.map( /*#__PURE__*/function () {
            var _ref24 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee23(row) {
              var cells;
              return _regeneratorRuntime().wrap(function _callee23$(_context23) {
                while (1) switch (_context23.prev = _context23.next) {
                  ...
                  case 2:
                    cells = _context23.sent;
                    return _context23.abrupt("return", Promise.all(cells.map(function (cell) {
        ...
        case 5:
          table = _context24.sent;
          return _context24.abrupt("return", JSON.stringify(table));
        case 7:
        case "end":
...
var elementEnabled = exports.elementEnabled = /*#__PURE__*/function () {
  var _ref25 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee25(page, elementIdentifier) {
    ...
    return _regeneratorRuntime().wrap(function _callee25$(_context25) {
      while (1) switch (_context25.prev = _context25.next) {
        ...
        case 2:
          enabled = _context25.sent;
          return _context25.abrupt("return", enabled);
        case 4:
        case "end":
  ...
  return function elementEnabled(_x62, _x63) {
    return _ref25.apply(this, arguments);
  };
}();
var elementChecked = exports.elementChecked = /*#__PURE__*/function () {
  var _ref26 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee26(page, elementIdentifier) {
    var checked;
    return _regeneratorRuntime().wrap(function _callee26$(_context26) {
      while (1) switch (_context26.prev = _context26.next) {
        ...
        case 2:
          checked = _context26.sent;
          return _context26.abrupt("return", checked);
        case 4:
        case "end":
  ...
  return function elementChecked(_x64, _x65) {
