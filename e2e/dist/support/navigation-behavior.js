...
var navigateToPage = exports.navigateToPage = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(page, pageId, _ref) {
    var _process$env$NODE_ENV, _process$env$MARKET;
    var pagesConfig, hostsConfig, environment, market, hostKey, hostPath, url, pageConfigItem;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          pagesConfig = _ref.pagesConfig, hostsConfig = _ref.hostsConfig;
          environment = (_process$env$NODE_ENV = process.env.NODE_ENV) !== null && _process$env$NODE_ENV !== void 0 ? _process$env$NODE_ENV : 'DEV';
          market = (_process$env$MARKET = process.env.MARKET) !== null && _process$env$MARKET !== void 0 ? _process$env$MARKET : 'PT';
          hostKey = "".concat(environment, "_").concat(market);
          hostPath = hostsConfig[hostKey];
          if (hostPath) {
            _context.next = 7;
            break;
          }
          throw Error("\uD83E\uDDE8 No host found for environment \"".concat(hostKey, "\" in hosts.json \uD83E\uDDE8"));
        case 7:
...
var reloadPage = exports.reloadPage = /*#__PURE__*/function () {
