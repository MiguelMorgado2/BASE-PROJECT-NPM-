...
(0, _cucumber.After)( /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(scenario) {
    ...
    var _this$screen, page, browser, scenarioStatus, safeName, screenshot;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          safeName = scenario.pickle.name.replace(/[^a-z0-9]/gi, '_');
          _context2.next = 6;
          return page.screenshot({
            path: "".concat((0, _parseEnv.env)('SCREENSHOT_PATH')).concat(safeName, ".png")
          });
        case 6:
